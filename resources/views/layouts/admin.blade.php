...
<body class="font-sans antialiased">
    <div class="min-h-screen bg-gray-100">
        ...
        <aside id="logo-sidebar" class="fixed  top-16 left-0 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
            <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                <ul class="space-y-2 font-medium">
                    ...
                    <ul id="dropdown-example" class="{{ request()->routeIs('admin.product.index', 'admin.voucher.index') ? 'false' : 'true' }} py-2 space-y-2">
                        <li>
